...
from src.map.map import osm, pbf_file_path

# street_network = osm.get_network(network_type='all')

# Convertir la red de calles a GeoDataFrame
gdf_streets = gpd.GeoDataFrame(street_network, geometry='geometry')

# # Visualizar la red de calles
gdf_streets.plot()
plt.show()
